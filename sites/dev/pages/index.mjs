              ...
              <div className="flex flex-row flex-wrap gap-4 justify-between">
                <div className="max-w-xl">
                  ...
                  <Popout note>
                    ...
                    <p>
                      Visit <WebLink href="https://v2.freesewing.dev/" txt="v2.freesewing.dev" />{' '}
                      for the documentation for version 2 of FreeSewing.
                    </p>
                  </Popout>
                </div>
                <div className="max-w-xl">
                  ...
                  <p>
                    ...
                    />{' '}
                    to learn about what is new in version 3 of FreeSewing, and what changes you
                    should make in your own designs to port them to version 3.
                  </p>
                  <Popout tip>
                    <p>
            ...
            <div className="flex flex-row flex-wrap gap-4 justify-between">
              ...
              <div className="max-w-xl">
                ...
                <Popout note compact>
                  ...
                  <PageLink href="/contact" txt="don't be shy" /> <span role="img">💜</span>
                </Popout>
              </div>
            </div>
          </div>
