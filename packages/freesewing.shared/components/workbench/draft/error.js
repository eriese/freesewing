      ...
      <Popout tip>
        ...
        <ul className="list-disc list-inside ml-4 text-xl">
            <li>
              ...
              <strong>{patternProps && patternProps.events ? patternProps.events.error.length : 0} errors</strong> and <strong>
              {patternProps && patternProps.events ? patternProps.events.warning.length : 0} warnings</strong></button>
            </li>
